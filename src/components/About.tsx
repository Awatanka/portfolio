...
const AboutMe: React.FC = () => {
  ...
  return (
    <>
      <Box sx={{ marginBottom: "80px" }} id="about">
        <motion.div
          ref={ref}
          ...
          >
            ...
            >
              ...
              <Box>
                ...
                exciting world of web and application development. I'm a
                versatile individual who can adapt to different working styles
                and collaborate effectively with team members of all levels of
                experience. I thrive in team environments and value
                collaboration, taking direction from team leads while also
                contributing my own ideas and suggestions. With my strong
                problem-solving skills and attention to detail, I ensure that
                every project I work on is a success.
              </Box>
            </Box>
          </Box>
        </motion.div>
